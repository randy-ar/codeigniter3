                            ...
                            <tbody>
                                ...
                                foreach ($dataBarang as $barang) {
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo base_url('assets/gambar/' . $barang->foto); ?>" width="100"
                                                height="100"> </td>
                                        <td><?= $barang->namaBarang ?></td>
                                        <td>Rp <?= number_format($barang->harga, 0, ',', '.') ?></td>
                                        <td><?= $barang->stok ?></td>
                                        <td>
                                            <a href="<?php echo base_url(); ?>barang/kurangstok/<?= $barang->idBarang ?>"
                                                title="Kurang" style="color:red" rel="tooltip"><i
                                                    class="mdi-hardware-keyboard-arrow-left"></i></a>
                                            <a href="<?php echo base_url(); ?>barang/tambahstok/<?= $barang->idBarang ?>"
                                                title="Kurang" style="color:blue" rel="tooltip"><i
