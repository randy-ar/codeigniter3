            ...
            <div id="table-datatables">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m8 l11">
                        <a href="<?php echo base_url(); ?>penjualan/export"
                            class="btn cyan waveseffect waves-light">Excel<i class="mdi-action-print right"></i></a>
                            ...
                            <tbody>
                                ...
                                foreach ($dataPenjualan as $penjualan) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $penjualan->qty ?></td>
                                        <td>Rp
                                            <?= number_format($penjualan->harga * $penjualan->qty, 0, ',', '.')
                                                ?>
                                        </td>
                                        <td><?= $penjualan->nama ?></td>
                                        <td>
                                            <a href="<?php echo base_url(); ?>penjualan/hapus/<?= $penjualan->idPenjualan ?>"
                                                data-target="modal1" class="modal-trigger" style="color:red" rel="tooltip"
                                                title="Hapus"><i class="mdi-action-delete"></i></a>
                                        </td>
                                    </tr>
                                    <!-- Modal Trigger -->
                                    <!-- Modal Structure -->
