            ...
            <div id="table-datatables">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m8 l11">
                        <a href="<?php echo base_url(); ?>member/import" class="btn blue ">Import Data Dari Excel<i
                            ...
                            <tbody>
                                ...
                                foreach ($member as $member) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo
                                                base_url(); ?>member/hapus/<?= $member->idMember ?>" data-target="modal1" class="modal-trigger" style="color:red"
