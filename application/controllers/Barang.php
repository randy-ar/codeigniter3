...
class barang extends CI_Controller
{
    ...
    public function tambahstok($idBarang)
    {
        if (!$this->session->userdata('level') == 'Petugas') {
            ...
            $this->m_barang->tambahStok($idBarang);

            $this->session->set_flashdata('info', 'Stok berhasil ditambah.');
    ...
    public function kurangstok($idBarang)
    {
        if (!$this->session->userdata('level') == 'Petugas') {
            ...
            $this->m_barang->kurangStok($idBarang);

            $this->session->set_flashdata('info', 'Stok berhasil dikurangi.');
            redirect('barang/stok');
        }
    }
