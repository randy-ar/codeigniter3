    ...
    function lupaPassword_act()
    {
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            $this->email->message(
                ...
                <p>Anda dapat login kembali dengan password baru Anda <a href=\"" . base_url() . "\" login\" target=\"_blank\" style=\"textdecoration:none;font-weight:bold;\">disini</a>.</p>
                </body>
                </html>"
            );
            if ($this->email->send()) {
